...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    try {
      ...
      const newListLoginData = [...parsedData, newLoginData]

      await AsyncStorage.setItem(dataKey, JSON.stringify(newListLoginData))

      reset()
      navigate('Home')
    } catch (error) {
      console.log(error)
      Alert.alert('Ops, houve um erro ao salvar os dados!')
    }
  }
